...
const parser = lr.LRParser.deserialize({
  ...
  maxTerm: 111,
  nodeProps: [
    [common.NodeProp.group, -5,34,35,36,37,38,"Expression",-28,40,42,44,46,48,50,52,54,56,58,60,62,64,66,68,70,72,74,76,78,80,82,84,86,88,90,92,94,"Type"]
  ],
  skippedNodes: [0,1,2],
  repeatNodeCount: 2,
...
const relLanguage = language.LRLanguage.define({
    parser: parser.configure({
        props: [
            ...
            // }),
            highlight.styleTags({
                'use forall for iff if then else end where with select implies': highlight.tags.controlKeyword,
                'in not and or xor': highlight.tags.operatorKeyword,
                'as from output inline ic doc': highlight.tags.keyword,
